...
The Pytest package is generally used as a command-line utility for running pre-defined files of "test" code. Follow the three exercises below to learn how to use it for the first time.
